...
describe('happy paths', () => {
    ...
    test.each(test_cases)(
        ...
        async (_, query, expected_result) => {
            // Arrange
            let spy = {
                fn: jest.spyOn(global.models.books.collection, 'findOneAndDelete')
            }

            // Action
            let res = await global.models.books.delete_one(query)
...
describe('unhappy paths', () => {
    ...
    test.each(test_cases)(
        ...
        async (_, query, expected_err_msg) => {
            ...
            let error
            try {
                await global.models.books.delete_one(query)
            } catch (e) {
                error = e
            }
